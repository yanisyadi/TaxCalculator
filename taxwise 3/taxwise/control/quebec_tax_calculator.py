...
class QuebecTaxCalculator(TaxCalculator):
    ...
    def calculate_tax(self,amount: float) -> float:
        ...
        amount = amount - self.tax_bracket_dao.find_threshold("quebec")
        applicable_brackets = self.tax_bracket_dao.find_applicable_brackets("quebec".capitalize(),amount)
        tax = 0.0
    ...
    def fetch_applicable_brackets(self,amount):
        return self.tax_bracket_dao.find_applicable_brackets('quebec'.capitalize(),amount)